...
void Login::GuardarVotantes(QString m_cedula)
{
    QFile archivoVoto;
    QTextStream lectura;
    archivoVoto.setFileName("C:/Users/Administrador/OneDrive/Documentos/Universidad Politecnica Salesiana/Segundo Semestre/Programación Orientada a objetos/Segundo Parcial/Proyecto/Login/Recursos/VotacionesRealizadas.txt");
...
bool Login::VerificarsiVoto(QString m_cedula)
{
    ...
    archivoVotos.setFileName("C:/Users/Administrador/OneDrive/Documentos/Universidad Politecnica Salesiana/Segundo Semestre/Programación Orientada a objetos/Segundo Parcial/Proyecto/Login/Recursos/VotacionesRealizadas.txt");     //madamos su direccion
    QTextStream votos;
...
void Login::leerPadronElectoral()
{
    ...
    QString nombreArchivo = "C:/Users/Administrador/OneDrive/Documentos/Universidad Politecnica Salesiana/Segundo Semestre/Programación Orientada a objetos/Segundo Parcial/Proyecto/Login/Recursos/Usuarios.txt";       //Variable que contienen la direccion del txt
