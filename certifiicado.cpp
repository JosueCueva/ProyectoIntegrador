...
void Certifiicado::generarCertificado(QString Cedula, QString Nombre, QString Lugar, int Hora, int Minuto, QString fecha,QString foto)
{
    ...
    QImage Foto(foto);
    QPixmap pix(foto);
    QImage baseImage("C:/Users/Administrador/OneDrive/Documentos/Universidad Politecnica Salesiana/Segundo Semestre/Programación Orientada a objetos/Segundo Parcial/Proyecto/Login/Recursos/Fondo.png");
